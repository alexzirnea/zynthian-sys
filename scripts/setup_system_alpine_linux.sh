...
[ -n "$ZYNTHIAN_SYS_BRANCH" ] || ZYNTHIAN_SYS_BRANCH="alpine-linux-port"
...
# echo yes | apk add python python-dev cython python-dbus python-setuptools
 echo yes | apk add python3 python3-dev py3-pip cython py3-cffi python3-tkinter py3-dbus py3-pillow py3-setuptools py3-numpy-dev py3-qt5 py3-libevdev
